...
to your Gemfile
 ...
 3. Add some editable text to your erb files with `<%= copilot_text 'slug', 'Editable Text' %>` or `<%= copilot_text 'slug' do %>  Editable Text <% end %>`
 4. Add a link to be able to edit the text `<%= link_to_copilot %>`
 5. Click the link to edit the text and enjoy the ride!
